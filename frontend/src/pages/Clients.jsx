...
export default function Clients() {
  ...
  return (
    <AdminLayout title="Database Client" subtitle="Kelola jadwal, fotografer, dan kirim invoice">
        ...
        <div className="flex items-center justify-between gap-2 w-full">
          ...
          <div className="flex bg-white rounded-xl border border-moss-900/10 p-1 shrink-0 shadow-sm">
            <Button
              ...
              className={`h-8 text-xs gap-1 px-3 rounded-lg ${viewMode === "table" ? "bg-moss-900 text-white hover:bg-moss-800" : "text-muted-foreground"}`}
            >
            ...
            <Button
              ...
              className={`h-8 text-xs gap-1 px-3 rounded-lg ${viewMode === "calendar" ? "bg-moss-900 text-white hover:bg-moss-800" : "text-muted-foreground"}`}
            >
      ...
      {viewMode === "calendar" ? (
        <div className="bg-white p-4 sm:p-6 rounded-2xl border border-moss-900/10 shadow-sm" style={{ height: 650 }}>
          <Calendar
            localizer={localizer}
        ...
        <div className="space-y-3 pb-20" data-testid="clients-cards">
          ...
          {/* Tampilan Data Berbentuk Card Modern & Estetik */}
          {safeBookings.map((b) => {
